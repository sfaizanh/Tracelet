...
class TlMotionConfig {
  TlMotionConfig({
    ...
    required this.stationaryGeofenceEnabled,
    required this.stationaryGeofenceRadius,
    required this.stationaryGeofenceIdentifier,
  });
  ...
  bool stationaryGeofenceEnabled;

  double stationaryGeofenceRadius;

  String stationaryGeofenceIdentifier;
  ...
  static TlMotionConfig decode(Object result) {
    ...
    return TlMotionConfig(
      ...
      stationaryGeofenceEnabled: result[22]! as bool,
      stationaryGeofenceRadius: result[23]! as double,
      stationaryGeofenceIdentifier: result[24]! as String,
    );
  }
